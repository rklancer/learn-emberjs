...
Learn = SC.Application.create({
  ...
  // These are for easy access to the iframe's window, document, SC, and $
  // Note they are directly accessible (using dot access instead of needing 'get') but are observable.
  _window: null,
  _document: null,
  _SC: null,
  _$: null,
  ...
  outputViewIframeChanged: function () {
    ...
    if (outputView.get('iframeIsLoaded')) {
