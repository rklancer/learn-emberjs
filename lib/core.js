...
Learn = Ember.Application.create({
...
Learn.sampleCodeController = Ember.Object.create({
...
Learn.EditorView = Ember.View.extend({
...
Learn.OutputView = Ember.View.extend({
...
Learn.RunButton = Ember.Button.extend({
  click: function () {
...
Learn.HelpButton = Ember.Button.extend({
    // TODO
    disabled: true
});
